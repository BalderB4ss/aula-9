...
with Session() as session:
    try:
        usuario_existente = session.query(Usuario).filter_by(email="querojogarresidentevil@gmail.com").first()
        if usuario_existente == None:
            #Criar um objeto
            usuario1 = Usuario( "Emilly", "querojogarresidentevil@gmail.com", 16, 5000)
